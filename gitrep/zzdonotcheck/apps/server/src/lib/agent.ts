...
- type: Type text into an input field OR select a dropdown option
...
- Set done: true when the task is complete — look for signs of success like new items appearing, forms closing, success messages, or the requested state being achieved
